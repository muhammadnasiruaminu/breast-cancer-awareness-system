...
<head>
  ...
  <!-- Title -->
  <title>Help Desk | Breast Cancer Awareness System</title>
      ...
      <div class="container content-space-2">
        <div class="row justify-content-lg-between align-items-md-center">
          <div class="col-md-6 mb-5 mb-md-0">
            ...
            <form action="demo-help-desk/login.php" method="POST">
              <!-- Input Card -->
              <div class="input-card mb-3">
                <div class="input-card-form">
                  <label for="searchAnswersForm" class="form-label visually-hidden">Search for answers</label>
                  <input type="text" readonly class="form-control form-control-lg" id="searchAnswersForm" placeholder="Search for answers" aria-label="Search for answers">
                </div>
                <button type="button" name="search" type="submit" class="btn btn-primary btn-lg">
                  <i class="bi-search"></i>
                </button>
              </div>
              <!-- End Input Card -->
    ...
    <div class="row justify-content-lg-between align-items-md-center">
      <div class="col-md-5 mb-7 mb-md-0">
        <div class="mb-5">
          ...
          <p>Protect your self, protect others. Learn more about HIV prevention and treatment #HIVawareness #KnowYourStatus.</p>
        </div>

        <!-- List Checked -->
        <ul class="list-checked list-checked-primary">
          <li class="list-checked-item">Get the fact, not the fiction. Learn more about HIV and how to prevent it. #HIVawareness #PreventionIsKey.</li>
          <li class="list-checked-item">Break the stigma, spread the knowlegde. Learn more about HIV and learn how to support those affected. #StaySafe</li>
          <li class="list-checked-item">HIV does'nt discriminate, but we can. Learn more about HIV and how to fight stigma and discrimation. #HIVawareness #EquilityForAll</li>
          <li class="list-checked-item">Know your status, know your power. Learn more about HIV testing and treatment</li>
        </ul>
        <!-- End List Checked -->
      </div>
      <!-- End Col -->
      ...
      <div class="col-md-7 col-lg-6">
        <!-- Form -->
        <form method="POST" action="demo-help-desk/create.php">
          <!-- Card -->
          <div class="card">
            <div class="card-header bg-primary text-center">
              <h5 class="card-header-title text-white">Sign up now to find more information about <span class="badge bg-warning text-dark rounded-pill ms-1">Breast Cancer</span></h5>
            </div>
